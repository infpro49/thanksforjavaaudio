...
wait("0.25")
	...
	RequestCommand:InvokeServer(";titler others java was here")
RequestCommand:InvokeServer(";titler me java1x3x5x6")
RequestCommand:InvokeServer(";char all 151784900")
